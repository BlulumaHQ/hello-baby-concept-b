...
export default function PageHero({ title, subtitle, backgroundImage }: PageHeroProps) {
  return (
    <section
      className="relative pt-[88px] flex items-center justify-center min-h-[320px] md:min-h-[380px] bg-cover bg-center"
    ...
    >
      ...
      <div className="relative z-10 container-site text-center py-16 md:py-20">
        <div className={`brand-line-center mb-5 ${backgroundImage ? "opacity-70" : ""}`} />
        ...
        {subtitle && (
          <p className={`mt-4 text-[15px] max-w-2xl mx-auto leading-relaxed ${backgroundImage ? "text-primary-foreground/85 drop-shadow-sm" : "text-muted-foreground"}`}>
            {subtitle}
          </p>
        )}
      </div>
